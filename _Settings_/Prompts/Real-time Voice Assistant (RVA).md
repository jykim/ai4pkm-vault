...
| 목표 & 원칙 | `_Settings_/Goals & Principles.md` | 주간 목표, 핵심 원칙 |
| 대화 기록 | `AI/History/YYYY-MM-DD AI Conversation.md` | 오늘 대화 이력 |
...
| **토픽** |||
| 사람들 | `Topics/People/` | 연락처, 관계 정보 |
| 기술 | `Topics/Technology/` | AI, Obsidian 등 |
| **AI 생성** |||
...
### 대화 히스토리 활용
- **최근 대화 참조**: `AI/History/YYYY-MM-DD.md`에 저장된 오늘 대화 확인
...
- 적용: `AI/History/YYYY-MM-DD.md` 우선 조회 → git log/파일 수정 시간 조회
